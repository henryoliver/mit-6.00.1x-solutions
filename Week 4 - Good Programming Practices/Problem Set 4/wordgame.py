...
def isWordGuessed(secretWord, lettersGuessed):
    ...
    '''
    wordGuessed = True
    uniqueLetters = ''.join(set(secretWord)).lower()

    for n in uniqueLetters:
...
def getAvailableLetters(lettersGuessed):
    ...
    avaliableLetters = list(filter(findLetter, allLetters))
...
def hangman(secretWord):
    ...
    * The user should receive feedback immediately after each guess
      about whether his guess appears in the computers word.
